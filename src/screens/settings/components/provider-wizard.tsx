...
export function ProviderWizard({ open, onOpenChange }: ProviderWizardProps) {
  ...
  return (
    <DialogRoot open={open} onOpenChange={handleDialogOpenChange}>
      <DialogContent className="w-[min(860px,96vw)] max-h-[88vh] overflow-auto border-primary-200 bg-primary-50/95 backdrop-blur-sm">
        <div className="p-4 sm:p-5">
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-1">
              <DialogTitle className="text-balance">Provider Setup Wizard</DialogTitle>
              ...
              return (
                <li
                  ...
                  className={cn(
                    ...
                    !isCurrent && !isComplete && 'border-primary-200 bg-primary-50',
                  )}
                >
            ...
            <section className="mt-5">
              ...
              <div className="mt-3 rounded-xl border border-primary-200 bg-primary-100/70 px-3 py-2">
                <p className="text-xs text-primary-700 text-pretty">
                  Config file path: <code className="font-mono">{OPENCLAW_CONFIG_PATH}</code>
                </p>
              </div>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                {AUTH_TYPE_ORDER.map(function mapAuthType(authType) {
                  ...
                  const supported = selectedProvider.authTypes.includes(authType)

  ...
  switch (expression) {
    case 'happy':
      return (
        <>
          {/* ^ ^ happy eyes */}
          <path d="M5 4 L6 3 L7 4" stroke="white" strokeWidth="0.8" fill="none" />
          <path d="M9 4 L10 3 L11 4" stroke="white" strokeWidth="0.8" fill="none" />
          {/* Small smile */}
          <path d="M6.5 5.5 Q8 7 9.5 5.5" stroke="white" strokeWidth="0.6" fill="none" />
        </>
      )
    case 'focused':
      return (
    ...
    case 'confused':
      return (
        <>
          ...
          <text x="13" y="2" fontSize="3" fill="#fbbf24" fontWeight="bold">?</text>
        </>
      )
    case 'tired':
      return (
        <>
          ...
          {/* zZz */}
          <text x="12" y="2" fontSize="2.5" fill="#94a3b8" fontWeight="bold">z</text>
          <text x="13.5" y="0.5" fontSize="2" fill="#94a3b8" fontWeight="bold">z</text>
        </>
      )
    case 'excited':
      return (
        <>
          {/* ★ ★ star eyes */}
          <text x="4.5" y="5" fontSize="3" fill="#fde047">★</text>
          <text x="8.5" y="5" fontSize="3" fill="#fde047">★</text>
          {/* Open mouth O */}
...
export function PixelAvatar({
  ...
  return (
    ...
    >
      ...
      {status === 'complete' && <circle cx="14" cy="2" r="1.5" fill="#34d399" />}

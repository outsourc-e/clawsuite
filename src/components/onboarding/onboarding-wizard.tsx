              ...
              <div className="flex items-center justify-between gap-3">
                ...
                {isLastStep ? (
                  <Button
                    variant="default"
                    onClick={complete}
                    className="gap-2 bg-orange-500 px-6 py-2.5 text-base font-medium shadow-lg shadow-orange-500/25 ring-1 ring-orange-400/20 transition-all hover:bg-orange-600 hover:shadow-xl hover:shadow-orange-500/30"
                  >
                    Get Started

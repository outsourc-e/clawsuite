...
const CHAT_RESULTS: Array<ChatMock> = [
  {
    id: 'chat-1',
    sessionKey: 'main',
    sessionName: 'Gateway Retry Strategy',
    message: 'Investigate why streaming chunks stop after provider reconnect.',
    timestamp: '09:41',
  },
  {
    id: 'chat-2',
    sessionKey: 'devops',
    sessionName: 'Deploy Script Audit',
    message: 'Need rollback-safe release script for staging to production.',
    timestamp: 'Yesterday',
  },
  {
    id: 'chat-3',
    sessionKey: 'perf',
    sessionName: 'Rendering Perf Pass',
    message: 'Memoize message rows to avoid rerenders during stream updates.',
    timestamp: '08:12',
  },
  {
    id: 'chat-4',
    sessionKey: 'agent-lab',
    sessionName: 'Agent Tooling',
    message: 'Design a tool sandbox that supports file and terminal actions.',
    timestamp: '02:17',
  },
  {
    id: 'chat-5',
    sessionKey: 'ui',
    sessionName: 'Sidebar Polish',
    message: 'Refine collapsed interactions and keyboard-first navigation.',
    timestamp: 'Mon',
  },
  {
    id: 'chat-6',
    sessionKey: 'research',
    sessionName: 'Prompt Evaluation',
    message: 'Compare baseline prompts against the safety-focused variant.',
    timestamp: 'Sat',
  },
]
...
const FILE_RESULTS: Array<FileMock> = [
  ...
  {
    id: 'file-2',
    path: 'src/components/file-explorer/file-explorer-sidebar.tsx',
    line: 144,
    snippet: 'const [search, setSearch] = useState(\'\')',
    ext: 'tsx',
  },
  {
    id: 'file-3',
    path: 'src/routes/api/history.ts',
    line: 64,
    snippet: 'if (!sessionKey) throw new Error(\'Missing session key\')',
    ext: 'ts',
  },
  {
    id: 'file-4',
    path: 'src/hooks/use-chat-settings.ts',
    line: 12,
    snippet: 'export type ThemeMode = "system" | "light" | "dark"',
    ext: 'ts',
  },
  {
    id: 'file-5',
    path: 'src/components/usage-meter/usage-meter.tsx',
    line: 426,
    snippet: 'const interval = window.setInterval(() => {',
    ext: 'tsx',
  },
]
...
const AGENT_RESULTS: Array<AgentMock> = [
  {
    id: 'agent-1',
    name: 'PR Reviewer',
    task: 'Audit auth middleware changes before merge',
    status: 'Running',
    runtime: '12m',
  },
  {
    ...
    task: 'Prepare schema migration and rollback SQL',
    status: 'Idle',
    runtime: '0m',
  },
  {
    ...
    task: 'Generate edge-case tests for terminal streaming',
    status: 'Queued',
    runtime: '1m',
  },
  {
    id: 'agent-4',
    name: 'Docs Curator',
    task: 'Summarize API changes for release notes',
    status: 'Success',
    runtime: '6m',
  },
]
...
const SKILL_RESULTS: Array<SkillMock> = [
  {
    id: 'skill-1',
    name: 'skill-creator',
    description: 'Guide for writing and maintaining reusable Codex skills.',
    installed: true,
  },
  {
    id: 'skill-2',
    name: 'skill-installer',
    description: 'Install curated skills from local or remote repositories.',
    installed: true,
  },
  {
    id: 'skill-3',
    name: 'terminal-sweeps',
    description: 'Run focused workspace cleanup and diagnostics quickly.',
    installed: false,
  },
  {
    id: 'skill-4',
    name: 'agent-bench',
    description: 'Benchmark prompts and compare quality across runs.',
    installed: false,
  },
  {
    id: 'skill-5',
    name: 'route-auditor',
    description: 'Find dead links and route regressions automatically.',
    installed: false,
  },
]
